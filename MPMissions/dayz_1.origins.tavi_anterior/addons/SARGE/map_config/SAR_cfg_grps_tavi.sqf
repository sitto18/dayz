...
// add if needed, see examples in the chernarus file
	...
	SAR_marker_car_bandAirport = _this;
...
//
	...
	[SAR_marker_car_bandMitro,1,["HMMWV_DES_EP1"],[[1,2,1]],true,60] call SAR_AI_land;
	
	// Bandit Car Patrol Branibor
	[SAR_marker_car_bandBranibor,1,["Kamaz"],[[1,1,1]],true,60] call SAR_AI_land;
	
	// Bandit Car Patrol Airport
	[SAR_marker_car_bandAirport,1,["Ural_INS"],[[1,3,4]],true,60] call SAR_AI_land;
