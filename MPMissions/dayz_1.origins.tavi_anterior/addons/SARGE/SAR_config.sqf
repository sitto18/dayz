...
SAR_sold_leader_weapon_list = ["M16A4_ACOG","M4A3_CCO_EP1","M4A1_HWS_GL","FN_FAL_ANPVS4","BAF_L85A2_RIS_CWS"];
...
SAR_sold_rifleman_weapon_list = ["M16A2","Mk_48","AKS_74_Kobra","M249","M240"];
...
SAR_sold_sniper_weapon_list = ["M4A1_Aim","SVD_CAMO","DMR","M14_EP1","m107","SVD_NSPU_EP1"];
...
// potential weapon list for leaders
SAR_surv_leader_weapon_list = ["M4A1","MP5SD","AK_107_GL_kobra","MP5A5","G36C"];
...
SAR_band_sniper_weapon_list = ["M4A1_Aim","SVD_CAMO","M24"];
